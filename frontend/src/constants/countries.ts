...
export const COUNTRIES: Country[] = [
  ...
  { code: "SCT", name: "Scotland", flag: "gb-sct" },
  { code: "WLS", name: "Wales", flag: "gb-wls" },
...
export function countryFlagClassForName(name: string): string | undefined {
  const country = BY_NAME.get(name);
  if (!country) return undefined;
  return (country.flag ?? country.code).toLowerCase();
}
